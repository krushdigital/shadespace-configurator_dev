  ...
  return (
    <div>
      ...
      <div className="relative">
        <input
          ref={ref}
          className={`w-full px-3 py-2 sm:px-4 sm:py-3 border-2 rounded-lg focus:ring-2 transition-all duration-200 text-[#01312D] text-base shadow-sm hover:shadow-md ${
