                ...
                <Tooltip
                  content={
                    <div>
                      ...
                      <p className="text-sm text-slate-600 mb-3">
                        With this option, you'll receive the shade sail fabric with corner D-rings sewn in. Tensioning hardware (turnbuckles, shackles, etc.) must be sourced separately.
                      </p>
