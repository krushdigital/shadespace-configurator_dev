                ...
                return (
                  <div key={edgeKey}>
                   <div className="relative">
                     ...
                     />
                     <div className={`absolute ${isSuccess ? 'right-11' : 'right-3'} bottom-[50px] text-xs text-[#01312D]/70 transition-all duration-200 pointer-events-none`}>
                          ...
                          <div className="grid grid-cols-1 gap-3 md:gap-4 md:grid-cols-2">
                            ...
                            <div>
                              <div className="relative">
                                ...
                                />
                                <span className={`absolute ${config.fixingHeights[index] && config.fixingHeights[index] > 0 ? 'right-11' : 'right-3'} bottom-[50px] text-xs text-[#01312D]/50 transition-all duration-200 pointer-events-none`}>
                                  {config.unit === 'metric' ? 'mm' : 'in'}
                                </span>
                              </div>
                            </div>
