  ...
  return (
    ...
    >
      <Button
        ...
        size="md"
        onClick={onClick}
        className={`${className} !bg-gradient-to-r !from-slate-100 !to-slate-50 hover:!from-slate-200 hover:!to-slate-100 !text-slate-600 hover:!text-slate-700 !border-slate-300 hover:!border-slate-400`}
