...
@keyframes sbp-edges { 0%, 34% { stroke-dashoffset: 260; opacity: 0; } 34.1% { opacity: 1; } 50%, 100% { stroke-dashoffset: 0; opacity: 1; } }
      ...
      <div style={{ background: 'radial-gradient(ellipse at 50% 60%, rgba(181,232,83,0.14), rgba(181,232,83,0) 65%)', borderRadius: 12 }}>
        <svg viewBox="0 0 100 100" style={{ width: '100%', display: 'block' }} aria-hidden="true">
          <g style={{ animation: 'sbp-scene 9s ease-in-out infinite' }}>
            ...
            <path d={SAIL_PATH} fill="none" stroke="#fff" strokeWidth={2.2} strokeLinejoin="round" style={{ strokeDasharray: 260, animation: 'sbp-edges 9s ease-in-out infinite' }} />
