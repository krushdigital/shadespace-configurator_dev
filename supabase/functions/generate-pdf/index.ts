...
<body>
    <div class="page">
        ...
        <!-- Your Account -->
        <div style="background-color: #01312D; border-radius: 10px; padding: 20px; margin: 30px 0; color: white;">
            <div style="font-size: 16px; font-weight: bold; color: #BFF102; margin-bottom: 10px;">Your ShadeSpace Account</div>
            <p style="font-size: 11px; line-height: 1.6; margin-bottom: 12px; color: #ffffff;">
                An account has been created for you. You can log in anytime to view your quotes and track orders -- no password needed.
            </p>
            <div style="background: white; border-radius: 8px; padding: 12px; color: #1E293B;">
                <p style="font-size: 11px; font-weight: bold; margin-bottom: 8px; color: #01312D;">How to log in:</p>
                <p style="font-size: 10px; line-height: 1.8; margin: 0; color: #334155;">
                    1. Go to <strong style="color: #307C31;">account.shadespace.com</strong><br/>
                    2. Enter the email address you used for this quote<br/>
                    3. Check your inbox for a one-time login code<br/>
